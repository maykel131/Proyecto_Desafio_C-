			...
			<section class="posts col-md-9">
				...
				<article class="post clearfix">
					...
					<div class="contenedor-botones">
						<asp:TextBox ID="TextBox1" runat="server" Height="16px" style="margin-left: 11px" placeholder="ex: 1 2 3 4" BackColor="#EAF8FD" ForeColor="#0066FF" ></asp:TextBox>
						<asp:Button class="btn btn-primary" ID="Button1" runat="server" OnClick="Button1_Click" Text="Clique" />
						<asp:Label ID="resultado1" runat="server" Text="Resultado"></asp:Label>
				...
				<article class="post clearfix">
					...
					<p><span class="post-fecha">Enero de 2018</span> por <span class="post-autor"><a href="http://maykeltrejo.webcindario.com/">Maykel Trejo</a></span></p>
					<p class="post-contenido text-justify">
					...
					<div class="contenedor-botones">
                        <asp:TextBox ID="TextBox2" runat="server" Height="21px" style="margin-left: 11px" placeholder="ex: 1 2 3 4 5" BackColor="#EAF8FD" Width="172px" ></asp:TextBox>
				...
				<article class="post clearfix">
					...
					<div class="contenedor-botones">
						 <asp:TextBox ID="TextBox3" runat="server" BackColor="#EAF8FD" placeholder="Tamanho"></asp:TextBox>
                         <asp:TextBox ID="TextBox4" runat="server" BackColor="#EAF8FD" placeholder="D1..DN"></asp:TextBox>
